...
pre_input="export UAV_NAME=uav1; export RUN_TYPE=simulation; export UAV_TYPE=f450; export WORLD_NAME=simulation; export SENSORS='garmin_down'; export PX4_SIM_SPEED_FACTOR=2.0"
...
"
  'Spawn' 'waitForSimulation; rosservice call /mrs_drone_spawner/spawn "1 --pos 10 10 0 0 $UAV_TYPE --enable-rplidar --use-gpu-ray --enable-rangefinder --enable-ground-truth --enable-bluefox-camera --enable-realsense-front"
'
